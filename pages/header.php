...
<head>
  ...
  <title>Lembaga Sertifikasi</title>
  <!-- plugins:css -->
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="peserta-input.php">Form Peserta</a></li>
              </ul>
            </div>
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="peserta.php">Data Peserta</a></li>
              </ul>
            </div>
          </li>
           <li class="nav-item">
